...
and Common/Inherited as ALL). `is_legitimate_mixture` remains only for 1.x source
...
| `bidi_skeleton_ltr(text)` | UTS #39 `bidiSkeleton(LTR, X)` with the spec fast path (no R/AL → internal) |
