...
- **Never edit `src/text/confusables_generated.rs`** — auto-generated sorted static table by `scripts/generate_confusables.py`. Edit the script, not the output. Use `lookup()` for single-character lookups.
