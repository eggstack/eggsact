...
11 named profiles control which tools are exposed. Counts below are what `tools/list` returns per audience (measured against v1.2.5; see [registry-profiles.md](registry-profiles.md) for the full reference).
