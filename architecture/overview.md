...
| Self-update HTTP/TLS (binary-only, not MCP/library API) | `eggfetch-core` 0.2.0 (`http1,tls-rustls,tls-native-roots,proxy`; hyper + rustls/ring in-process), `futures-util` (streaming) |
