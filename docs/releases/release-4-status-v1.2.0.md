> **Historical document.** This records the v1.2.0 Release 4 verification status.
...
- **Ordinary CI**: [30306974684](https://github.com/eggstack/eggsact/actions/runs/30306974684) — all 12 jobs success (on CODE_SHA `3e5b41c`)
- **Release verification**: [30306975072](https://github.com/eggstack/eggsact/actions/runs/30306975072) — Full Release Gate success (on CODE_SHA `3e5b41c`)
...
- **Latest-compatible**: [30306975876](https://github.com/eggstack/eggsact/actions/runs/30306975876) — success (on CODE_SHA `3e5b41c`)
- **Python parity**: [30306976324](https://github.com/eggstack/eggsact/actions/runs/30306976324) — success (on CODE_SHA `3e5b41c`)
