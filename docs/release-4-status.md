...
| Package provenance | Artifact ID `8624794842`, SHA-256 `7f977abf...`; records version, commit, MSRV, toolchain, lockfile, 235 files | Complete |
...
- **Release verification**: [30177462182](https://github.com/eggstack/eggsact/actions/runs/30177462182) — all 18 jobs success (on exact CODE_SHA `06f7a0b`)
